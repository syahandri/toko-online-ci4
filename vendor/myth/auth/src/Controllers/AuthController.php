...
class AuthController extends Controller
{
   ...
   public function attemptRegister()
   {
      ...
      // Save the user
      $allowedPostFields = array_merge(['password'], $this->config->additionalFields, $this->config->validFields, $this->config->personalFields);
   ...
   public function forgotPassword()
   {
      ...
      return $this->_render($this->config->views['forgot'], ['config' => $this->config, 'title' => 'Lupa Password']);
   }
   ...
   public function activateAccount()
   {
      ...
      // Save to history users
      $db      = \Config\Database::connect();
      $builder = $db->table('historyusers');
      $builder->insert([
         'user_id' => $user->id,
         'tgl_registrasi' => $user->created_at
      ]);
